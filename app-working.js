...
const profileBloodGroupOptions = ["A+", "A-", "B+", "B-", "AB+", "AB-", "O+", "O-", "Unknown"];
const profileHouseOptions = ["Blue", "Green", "Red", "White"];
const profileResidentialOptions = ["Day Scholar", "Hosteller"];
const profileAdmissionOptions = ["Continuing Student", "Newcomer"];
const profileStatusOptions = ["Active", "Transferred", "Withdrawn", "Graduated", "Inactive"];
const profileReligionOptions = ["Christian", "Hindu", "Muslim", "Buddhist", "Other"];
const profileDenominationOptions = ["SDA", "NON-SDA"];
const profileBplAayOptions = ["BPL", "AAY", "None"];
const profileSkillProgrammeOptions = [
  "Baking",
  "Art and Crafts",
  "Music",
  "Electric Wiring",
...
let editingStudentProfileId = "";
let studentProfilePage = 1;
let studentProfileSummaryClassFilter = "All";
let studentProfilePhotoDraft = null;
let studentProfilePhotoPreviewUrl = "";
let studentProfilePhotoPreviousPreviewHtml = "";
const studentPhotoCropState = {
  image: null,
  objectUrl: "",
  zoom: 1,
  minScale: 1,
...
const els = {
  ...
  addStudentProfileBtn: document.querySelector("#addStudentProfileBtn"),
  downloadStudentProfileSampleBtn: document.querySelector("#downloadStudentProfileSampleBtn"),
  importStudentProfilesBtn: document.querySelector("#importStudentProfilesBtn"),
  studentProfileCsvInput: document.querySelector("#studentProfileCsvInput"),
  exportStudentProfilesBtn: document.querySelector("#exportStudentProfilesBtn"),
  exportStudentProfilesTableBtn: document.querySelector("#exportStudentProfilesTableBtn"),
  printStudentProfilesBtn: document.querySelector("#printStudentProfilesBtn"),
  studentProfileSummary: document.querySelector("#studentProfileSummary"),
  studentProfileAgeReport: document.querySelector("#studentProfileAgeReport"),
  studentProfilePanel: document.querySelector("#studentProfilePanel"),
  studentProfileForm: document.querySelector("#studentProfileForm"),
  studentProfileFormTitle: document.querySelector("#studentProfileFormTitle"),
  ...
  profileHouseFilter: document.querySelector("#profileHouseFilter"),
  profileResidentialFilter: document.querySelector("#profileResidentialFilter"),
  profileAdmissionFilter: document.querySelector("#profileAdmissionFilter"),
  profileReligionFilter: document.querySelector("#profileReligionFilter"),
  profileDenominationFilter: document.querySelector("#profileDenominationFilter"),
  profileSkillFilter: document.querySelector("#profileSkillFilter"),
  profileStatusFilter: document.querySelector("#profileStatusFilter"),
  profileSearchInput: document.querySelector("#profileSearchInput"),
  profileSortSelect: document.querySelector("#profileSortSelect"),
  studentProfileCount: document.querySelector("#studentProfileCount"),
  studentProfileBody: document.querySelector("#studentProfileBody"),
  studentProfileCards: document.querySelector("#studentProfileCards"),
  profilePrevPageBtn: document.querySelector("#profilePrevPageBtn"),
  profileNextPageBtn: document.querySelector("#profileNextPageBtn"),
  profilePageInfo: document.querySelector("#profilePageInfo"),
  profilePhotoInput: document.querySelector("#profilePhotoInput"),
  profilePhotoPreview: document.querySelector("#profilePhotoPreview"),
  studentPhotoCropModal: document.querySelector("#studentPhotoCropModal"),
  closeStudentPhotoCropBtn: document.querySelector("#closeStudentPhotoCropBtn"),
  studentPhotoCropCanvas: document.querySelector("#studentPhotoCropCanvas"),
  studentPhotoZoomInput: document.querySelector("#studentPhotoZoomInput"),
  studentPhotoCropResetBtn: document.querySelector("#studentPhotoCropResetBtn"),
  studentPhotoCropApplyBtn: document.querySelector("#studentPhotoCropApplyBtn"),
  profileRollInput: document.querySelector("#profileRollInput"),
  profileNameInput: document.querySelector("#profileNameInput"),
  profileClassInput: document.querySelector("#profileClassInput"),
  profileSectionInput: document.querySelector("#profileSectionInput"),
  profileSchoolIdInput: document.querySelector("#profileSchoolIdInput"),
  profileGenderInput: document.querySelector("#profileGenderInput"),
  profileDobInput: document.querySelector("#profileDobInput"),
  profileAgeInput: document.querySelector("#profileAgeInput"),
  profileBloodGroupInput: document.querySelector("#profileBloodGroupInput"),
  profileHouseInput: document.querySelector("#profileHouseInput"),
  profileAddressInput: document.querySelector("#profileAddressInput"),
  profileLandmarkInput: document.querySelector("#profileLandmarkInput"),
  profileStudentContactInput: document.querySelector("#profileStudentContactInput"),
  profilePrimaryContactInput: document.querySelector("#profilePrimaryContactInput"),
  profileAlternateContactInput: document.querySelector("#profileAlternateContactInput"),
  profilePenInput: document.querySelector("#profilePenInput"),
  profileAadhaarInput: document.querySelector("#profileAadhaarInput"),
  profileAparInput: document.querySelector("#profileAparInput"),
  profileNationalityInput: document.querySelector("#profileNationalityInput"),
  profileFatherInput: document.querySelector("#profileFatherInput"),
  profileFatherContactInput: document.querySelector("#profileFatherContactInput"),
  profileMotherInput: document.querySelector("#profileMotherInput"),
  profileMotherContactInput: document.querySelector("#profileMotherContactInput"),
  profileGuardianInput: document.querySelector("#profileGuardianInput"),
  profileGuardianRelationshipInput: document.querySelector("#profileGuardianRelationshipInput"),
  profileGuardianContactInput: document.querySelector("#profileGuardianContactInput"),
  profileParentAadhaarInput: document.querySelector("#profileParentAadhaarInput"),
  profileReligionInput: document.querySelector("#profileReligionInput"),
  profileDenominationInput: document.querySelector("#profileDenominationInput"),
  profileBplAayInput: document.querySelector("#profileBplAayInput"),
  profileResidentialInput: document.querySelector("#profileResidentialInput"),
  profileAdmissionInput: document.querySelector("#profileAdmissionInput"),
  profileAdmissionNoInput: document.querySelector("#profileAdmissionNoInput"),
  profileAdmissionDateInput: document.querySelector("#profileAdmissionDateInput"),
...
function normalizeState(existingState = {}) {
  ...
  parsed.studentProfiles = normalizeStudentProfiles(existingState.studentProfiles || parsed.studentProfiles);
...
function normalizeStudentProfileSettings(settings = {}) {
  return {
    houseColours: Array.isArray(settings.houseColours) && settings.houseColours.length
      ? settings.houseColours.map(normalizeHouseColour).filter(Boolean)
      : profileHouseOptions,
    skillDevelopmentProgrammes: Array.isArray(settings.skillDevelopmentProgrammes) && settings.skillDevelopmentProgrammes.length
      ? settings.skillDevelopmentProgrammes.map((item) => String(item || "").trim()).filter(Boolean)
      : profileSkillProgrammeOptions
  };
}

function normalizeStudentProfiles(profiles = {}) {
  return Object.fromEntries(
    Object.entries(profiles || {}).map(([studentId, profile]) => [
      studentId,
      normalizeStudentProfile({ ...profile, studentId: profile.studentId || studentId })
    ])
  );
}
...
function normalizeHouseColour(value) {
  const text = String(value || "").trim();
  return text.toLowerCase() === "yellow" ? "White" : text;
}
...
function normalizeStudentProfile(profile = {}) {
  ...
  return {
    ...
    normalizedName: normalizeProfileSearchText(profile.normalizedName || profile.studentName || profile.name || ""),
    schoolIdNo: String(profile.schoolIdNo || profile.idNo || "").trim(),
    gender: String(profile.gender || "").trim(),
    dateOfBirth: formatDateForInput(profile.dateOfBirth || ""),
    bloodGroup: profileBloodGroupOptions.includes(profile.bloodGroup) ? profile.bloodGroup : "Unknown",
    address: String(profile.address || "").trim(),
    landmark: String(profile.landmark || "").trim(),
    studentContact: String(profile.studentContact || "").trim(),
    primaryParentContact: String(profile.primaryParentContact || profile.primaryContact || "").trim(),
    alternateContact: String(profile.alternateContact || "").trim(),
    pen: String(profile.pen || "").trim(),
    aadhaarNo: String(profile.aadhaarNo || "").trim(),
    aparId: String(profile.aparId || "").trim(),
    fatherName: String(profile.fatherName || "").trim(),
    fatherContact: String(profile.fatherContact || "").trim(),
    motherName: String(profile.motherName || "").trim(),
    motherContact: String(profile.motherContact || "").trim(),
    guardianName: String(profile.guardianName || "").trim(),
    guardianRelationship: String(profile.guardianRelationship || "").trim(),
    guardianContact: String(profile.guardianContact || "").trim(),
    parentGuardianAadhaar: String(profile.parentGuardianAadhaar || "").trim(),
    nationality: String(profile.nationality || "Indian").trim(),
    religion: String(profile.religion || "").trim(),
    denomination: String(profile.denomination || "").trim(),
...
function normalizeStudentEnrolments(enrolments = {}) {
  return Object.fromEntries(
    Object.entries(enrolments || {}).map(([sessionId, sessionEnrolments]) => [
      currentSessionKey(sessionId),
      Object.fromEntries(
        Object.entries(sessionEnrolments || {}).map(([studentId, enrolment]) => [
          studentId,
          normalizeStudentEnrolment({ ...enrolment, studentId: enrolment.studentId || studentId, academicSessionId: sessionId })
        ])
      )
    ])
  );
...
function normalizeStudentEnrolment(enrolment = {}) {
  return {
    ...
    academicSessionId: currentSessionKey(enrolment.academicSessionId || "2026 - 2027"),
    className: classNames.includes(enrolment.className) ? enrolment.className : "LKG",
    section: String(enrolment.section || "").trim(),
    rollNumber: String(enrolment.rollNumber ?? enrolment.roll ?? "").trim(),
    houseColour: normalizeHouseColour(enrolment.houseColour),
    residentialStatus: profileResidentialOptions.includes(enrolment.residentialStatus) ? enrolment.residentialStatus : "Day Scholar",
    admissionType: profileAdmissionOptions.includes(enrolment.admissionType) ? enrolment.admissionType : "Continuing Student",
    skillDevelopmentProgramme: String(enrolment.skillDevelopmentProgramme || "").trim(),
    skillDevelopmentGroup: String(enrolment.skillDevelopmentGroup || "").trim(),
    instructor: String(enrolment.instructor || "").trim(),
    studentStatus: profileStatusOptions.includes(enrolment.studentStatus) ? enrolment.studentStatus : "Active",
    promotedFromClass: String(enrolment.promotedFromClass || "").trim(),
...
function loadSavedUiState() {
  ...
  try {
    ...
    return {
      ...parsed,
      activeView: portalViews.includes(routeView) ? routeView : portalViews.includes(parsed.activeView) ? parsed.activeView : "dashboard"
    };
  } catch {
...
function viewFromLocationHash() {
  ...
  return portalViews.includes(routeView) ? routeView : "";
}
...
function saveUiState() {
  ...
  localStorage.setItem(uiKey, JSON.stringify({
    ...
    profileClass: els.profileClassFilter?.value || "All Classes",
    profileSection: els.profileSectionFilter?.value || "All",
    profileGender: els.profileGenderFilter?.value || "All Genders",
    profileHouse: els.profileHouseFilter?.value || "All Houses",
    profileResidential: els.profileResidentialFilter?.value || "All Residential Status",
    profileAdmission: els.profileAdmissionFilter?.value || "All Admission Types",
    profileReligion: els.profileReligionFilter?.value || "All Religions",
    profileDenomination: els.profileDenominationFilter?.value || "All Denominations",
    profileSkill: els.profileSkillFilter?.value || "All Programmes",
    profileStatus: els.profileStatusFilter?.value || "All Status",
    profileSearch: els.profileSearchInput?.value || "",
    profileSort: els.profileSortSelect?.value || "roll",
...
function applyRemoteStateToCurrentView(uiState) {
  ...
  initializeStudentProfileControls(uiState);
...
function renderAuth() {
  ...
  els.downloadStudentProfileSampleBtn?.classList.toggle("hidden", !isAdmin());
  els.importStudentProfilesBtn?.classList.toggle("hidden", !isAdmin());
...
function init() {
  ...
  initializeStudentProfileControls(savedUiState);
...
function startPrintMode(printClass, extraClass = "") {
  ...
  document.body.classList.remove("print-results", "print-marksheets", "print-current-marksheet", "print-all-marksheets", "print-analysis", "print-teacher-analysis", "print-teacher-assessment", "print-student-profiles");
...
function profileAll(label) {
  return `All ${label}`;
}

function profileSettings() {
  return normalizeStudentProfileSettings(state.studentProfileSettings || {});
}

function setProfileSelectOptions(select, options = [], selectedValue = "", allLabel = "") {
  if (!select) return;
  const values = [...new Set(options.map((option) => String(option || "").trim()).filter(Boolean))];
  const current = selectedValue || select.value;
  select.innerHTML = [
    ...(allLabel ? [`<option value="${escapeAttr(allLabel)}">${escapeHtml(allLabel)}</option>`] : []),
    ...values.map((option) => `<option value="${escapeAttr(option)}">${escapeHtml(option)}</option>`)
  ].join("");
  setSelectValueIfAvailable(select, current);
}

function initializeStudentProfileControls(uiState = {}) {
  const settings = profileSettings();
  const records = getStudentProfileRecords({ includeUnauthorized: true });
  const bplAayValues = [...profileBplAayOptions, ...records.map((record) => record.bplAay)].filter(Boolean);
  const religions = [...profileReligionOptions, ...records.map((record) => record.religion)].filter(Boolean);
  const denominations = [...profileDenominationOptions];
  const skillProgrammes = [...settings.skillDevelopmentProgrammes, ...records.map((record) => record.skillDevelopmentProgramme)].filter(Boolean);
  const houses = [...settings.houseColours, ...records.map((record) => record.houseColour)].filter(Boolean);

  setProfileSelectOptions(els.profileClassFilter, classNames, uiState.profileClass || profileAll("Classes"), profileAll("Classes"));
  const savedBplAayFilter = uiState.profileSection === profileAll("BPL/AAY") ? "All" : uiState.profileSection;
  setProfileSelectOptions(els.profileSectionFilter, bplAayValues, savedBplAayFilter || "All", "All");
  setProfileSelectOptions(els.profileGenderFilter, profileGenderOptions, uiState.profileGender || profileAll("Genders"), profileAll("Genders"));
  setProfileSelectOptions(els.profileHouseFilter, houses, uiState.profileHouse || profileAll("Houses"), profileAll("Houses"));
  setProfileSelectOptions(els.profileResidentialFilter, profileResidentialOptions, uiState.profileResidential || profileAll("Residential Status"), profileAll("Residential Status"));
  setProfileSelectOptions(els.profileAdmissionFilter, profileAdmissionOptions, uiState.profileAdmission || profileAll("Admission Types"), profileAll("Admission Types"));
  setProfileSelectOptions(els.profileReligionFilter, religions, uiState.profileReligion || profileAll("Religions"), profileAll("Religions"));
  setProfileSelectOptions(els.profileDenominationFilter, denominations, uiState.profileDenomination || profileAll("Denominations"), profileAll("Denominations"));
  setProfileSelectOptions(els.profileSkillFilter, skillProgrammes, uiState.profileSkill || profileAll("Programmes"), profileAll("Programmes"));
  setProfileSelectOptions(els.profileStatusFilter, profileStatusOptions, uiState.profileStatus || profileAll("Status"), profileAll("Status"));
  setProfileSelectOptions(els.profileClassInput, classNames, uiState.profileClassInput || selectedClass());
  setProfileSelectOptions(els.profileGenderInput, profileGenderOptions);
  setProfileSelectOptions(els.profileBloodGroupInput, profileBloodGroupOptions);
  setProfileSelectOptions(els.profileHouseInput, houses);
  setProfileSelectOptions(els.profileReligionInput, religions);
  setProfileSelectOptions(els.profileDenominationInput, denominations);
  setProfileSelectOptions(els.profileBplAayInput, bplAayValues);
  setProfileSelectOptions(els.profileResidentialInput, profileResidentialOptions);
  setProfileSelectOptions(els.profileAdmissionInput, profileAdmissionOptions);
  setProfileSelectOptions(els.profileStatusInput, profileStatusOptions);
  setProfileSelectOptions(els.profileSkillProgrammeInput, skillProgrammes);

  if (els.profileSearchInput) els.profileSearchInput.value = uiState.profileSearch || els.profileSearchInput.value || "";
  if (els.profileSortSelect) setSelectValueIfAvailable(els.profileSortSelect, uiState.profileSort || "roll");
}

function setupStudentProfileEvents() {
  els.addStudentProfileBtn?.addEventListener("click", openNewStudentProfileForm);
  els.downloadStudentProfileSampleBtn?.addEventListener("click", downloadStudentProfileCsvSample);
  els.importStudentProfilesBtn?.addEventListener("click", () => els.studentProfileCsvInput?.click());
  els.studentProfileCsvInput?.addEventListener("change", importStudentProfilesCsv);
  els.studentProfileSummary?.addEventListener("change", (event) => {
    if (event.target?.id !== "studentProfileSummaryClassFilter") return;
    studentProfileSummaryClassFilter = event.target.value || "All";
    renderStudentProfileSummary(getStudentProfileRecords());
  });
  ...
  els.studentPhotoCropResetBtn?.addEventListener("click", resetStudentPhotoCrop);
  els.studentPhotoCropApplyBtn?.addEventListener("click", applyStudentPhotoCrop);
  els.studentPhotoZoomInput?.addEventListener("input", updateStudentPhotoCropZoom);
  els.studentPhotoCropCanvas?.addEventListener("pointerdown", startStudentPhotoCropDrag);
  els.studentPhotoCropCanvas?.addEventListener("pointermove", dragStudentPhotoCrop);
  els.studentPhotoCropCanvas?.addEventListener("pointerup", endStudentPhotoCropDrag);
  els.studentPhotoCropCanvas?.addEventListener("pointercancel", endStudentPhotoCropDrag);
  els.studentPhotoCropCanvas?.addEventListener("pointerleave", endStudentPhotoCropDrag);
  els.profileDobInput?.addEventListener("change", updateStudentProfileAge);
  els.exportStudentProfilesBtn?.addEventListener("click", exportStudentProfilesCsv);
  els.exportStudentProfilesTableBtn?.addEventListener("click", exportStudentProfilesCsv);
  els.printStudentProfilesBtn?.addEventListener("click", printStudentProfilesList);
  els.profilePrevPageBtn?.addEventListener("click", () => {
    studentProfilePage = Math.max(1, studentProfilePage - 1);
    renderStudentProfiles();
  });
  els.profileNextPageBtn?.addEventListener("click", () => {
    studentProfilePage += 1;
    renderStudentProfiles();
  });

  [
    els.profileClassFilter,
    els.profileSectionFilter,
    els.profileGenderFilter,
    els.profileHouseFilter,
    els.profileResidentialFilter,
    els.profileAdmissionFilter,
    els.profileReligionFilter,
    els.profileDenominationFilter,
    els.profileSkillFilter,
    els.profileStatusFilter,
    els.profileSortSelect
  ].forEach((control) => {
    control?.addEventListener("change", () => {
      studentProfilePage = 1;
      saveUiState();
  ...
  const handleAction = (event) => {
    ...
    if (!button) return;
    handleStudentProfileAction(button.dataset.profileAction, button.dataset.profileId);
  };
  els.studentProfileBody?.addEventListener("click", handleAction);
  els.studentProfileCards?.addEventListener("click", handleAction);
  els.studentProfilePanel?.addEventListener("click", handleAction);
}

function studentProfileIdFromLegacy(className, student) {
  if (student?.studentId) return String(student.studentId);
  const idSeed = student?.idNo || student?.pen || student?.aadhaarNo || `${className}-${student?.roll || ""}-${student?.name || ""}`;
...
function getStudentProfileRecords(options = {}) {
  const includeUnauthorized = Boolean(options.includeUnauthorized);
  const session = currentSessionKey(state.academicSession);
  ...
  classNames.forEach((className) => {
    (state.classes?.[className] || []).forEach((student) => {
      ...
      const profile = normalizeStudentProfile({
        ...(matchedProfile || {}),
        studentId,
        studentName: matchedProfile?.studentName || student.name,
        schoolIdNo: matchedProfile?.schoolIdNo || student.idNo,
        dateOfBirth: matchedProfile?.dateOfBirth || student.dateOfBirth,
        fatherName: matchedProfile?.fatherName || student.fatherName,
        motherName: matchedProfile?.motherName || student.motherName,
        address: matchedProfile?.address || student.address,
        pen: matchedProfile?.pen || student.pen,
        aadhaarNo: matchedProfile?.aadhaarNo || student.aadhaarNo
      });
      const enrolment = normalizeStudentEnrolment({
        ...(enrolments[studentId] || {}),
        studentId,
        academicSessionId: session,
        className,
        rollNumber: enrolments[studentId]?.rollNumber || student.roll,
        studentStatus: enrolments[studentId]?.studentStatus || "Active"
      });
      const record = profileRecord(profile, enrolment, student);
      if (includeUnauthorized || canViewStudentProfileRecord(record)) records.push(record);
      used.add(studentId);
    });
  });
  ...
  Object.entries(enrolments).forEach(([studentId, enrolment]) => {
    ...
    const profile = normalizeStudentProfile({ ...(state.studentProfiles?.[studentId] || {}), studentId });
    const record = profileRecord(profile, normalizeStudentEnrolment(enrolment), null);
    if (includeUnauthorized || canViewStudentProfileRecord(record)) records.push(record);
  });
...
function profileRecord(profile, enrolment, legacyStudent) {
  const searchText = normalizeProfileSearchText([
    profile.studentName,
    profile.schoolIdNo,
    profile.admissionNo,
    enrolment.rollNumber,
    profile.pen,
    profile.aparId,
    profile.bplAay,
    profile.fatherName,
  ...
  return {
    ...
    legacyStudent,
    searchText,
    rollNumber: String(enrolment.rollNumber || "").trim()
  };
}

function canViewStudentProfileRecord(record) {
  if (isAdmin() || isPrincipalUser() || isHeadmasterUser()) return true;
  return currentUser?.role === "user" && isAssignedTeacherForClass(record.className);
}

function canEditStudentProfileRecord(record) {
  if (isAdmin() || isPrincipalUser() || isHeadmasterUser()) return true;
...
function isAssignedTeacherForClass(className) {
  ...
  const userAssignments = assignments.filter((assignment) => {
    ...
    return teacherId === username
      || slugifyTeacherName(teacherName) === username
      || (name && teacherName.toLowerCase() === name.toLowerCase());
  });
  if (currentUser.role === "user" && userAssignments.length === 0) return true;
  return userAssignments.some((assignment) => assignment.className === className || assignment.className === "All Classes");
}

function isStudentProfileEntryAccessOpen(className) {
  const exams = currentExams(className);
  return exams.length === 0 || exams.some((exam) => isEntryAccessOpen(className, exam));
}

function visibleStudentProfileRecords() {
  const search = normalizeProfileSearchText(els.profileSearchInput?.value || "");
  const filterValue = (select) => String(select?.value || "");
  const classFilter = filterValue(els.profileClassFilter);
  const bplAayFilter = filterValue(els.profileSectionFilter);
  const genderFilter = filterValue(els.profileGenderFilter);
  const houseFilter = filterValue(els.profileHouseFilter);
  const residentialFilter = filterValue(els.profileResidentialFilter);
  const admissionFilter = filterValue(els.profileAdmissionFilter);
  const religionFilter = filterValue(els.profileReligionFilter);
  const denominationFilter = filterValue(els.profileDenominationFilter);
  const skillFilter = filterValue(els.profileSkillFilter);
  const statusFilter = filterValue(els.profileStatusFilter);
  const records = getStudentProfileRecords().filter((record) =>
    (!search || record.searchText.includes(search))
    && (classFilter === profileAll("Classes") || record.className === classFilter)
    && (bplAayFilter === "All" || bplAayFilter === profileAll("BPL/AAY") || record.bplAay === bplAayFilter)
    && (genderFilter === profileAll("Genders") || record.gender === genderFilter)
    && (houseFilter === profileAll("Houses") || record.houseColour === houseFilter)
    && (residentialFilter === profileAll("Residential Status") || record.residentialStatus === residentialFilter)
    && (admissionFilter === profileAll("Admission Types") || record.admissionType === admissionFilter)
    && (religionFilter === profileAll("Religions") || record.religion === religionFilter)
    && (denominationFilter === profileAll("Denominations") || record.denomination === denominationFilter)
    && (skillFilter === profileAll("Programmes") || record.skillDevelopmentProgramme === skillFilter)
    && (statusFilter === profileAll("Status") || record.studentStatus === statusFilter)
  );
  return sortStudentProfileRecords(records);
}

function sortStudentProfileRecords(records) {
  const sort = els.profileSortSelect?.value || "roll";
  const classIndex = Object.fromEntries(classNames.map((className, index) => [className, index]));
  return [...records].sort((a, b) => {
    if (sort === "name") return a.studentName.localeCompare(b.studentName);
    if (sort === "class") {
      const classCompare = (classIndex[a.className] ?? 99) - (classIndex[b.className] ?? 99);
      if (classCompare) return classCompare;
    }
    if (sort === "status") {
      const statusCompare = String(a.studentStatus).localeCompare(String(b.studentStatus));
      if (statusCompare) return statusCompare;
    }
    const rollCompare = Number(a.rollNumber || 0) - Number(b.rollNumber || 0);
    return rollCompare || a.studentName.localeCompare(b.studentName);
  });
}
...
function renderStudentProfileSummary(records) {
  const selectedClass = classNames.includes(studentProfileSummaryClassFilter) ? studentProfileSummaryClassFilter : "All";
  studentProfileSummaryClassFilter = selectedClass;
  const summaryRecords = selectedClass === "All"
    ? records
    : records.filter((record) => record.className === selectedClass);
  const total = Math.max(0, summaryRecords.length);
  const hasValue = (value) => String(value || "").trim() !== "";
  const countWhere = (predicate) => summaryRecords.filter(predicate).length;
  const summaryItems = [
    { key: "total", label: "Total Students", count: total },
    { key: "active", label: "Active Students", count: countWhere((record) => record.studentStatus === "Active") },
    { key: "boys", label: "Boys", count: countWhere((record) => record.gender === "Male") },
    { key: "girls", label: "Girls", count: countWhere((record) => record.gender === "Female") },
    { key: "dayScholars", label: "Day Scholars", count: countWhere((record) => record.residentialStatus === "Day Scholar") },
    { key: "hostellers", label: "Hostellers", count: countWhere((record) => record.residentialStatus === "Hosteller") },
    { key: "continuing", label: "Continuing Students", count: countWhere((record) => record.admissionType === "Continuing Student") },
    { key: "newcomers", label: "Newcomers", count: countWhere((record) => record.admissionType === "Newcomer") },
    { key: "withPen", label: "Students with PEN", count: countWhere((record) => hasValue(record.pen)) },
    { key: "withoutPen", label: "Students without PEN", count: countWhere((record) => !hasValue(record.pen)) },
    ...
    return {
      ...item,
      percentage,
      colors: studentProfileCylinderPalette(index)
    };
  });
  const classOptions = ["All", ...classNames].map((className) =>
    `<option value="${escapeAttr(className)}"${className === selectedClass ? " selected" : ""}>${escapeHtml(className)}</option>`
  ).join("");
  const gridMinWidth = Math.max(760, summaryItems.length * 118);
  els.studentProfileSummary.innerHTML = `
    <div class="student-profile-summary-head">
      <div>
        <span class="eyebrow">Student Profile Summary</span>
        <h4>Category-wise Overview</h4>
        <p>${selectedClass === "All" ? "All classes" : escapeHtml(selectedClass)} category distribution</p>
      </div>
      <div class="student-profile-summary-tools">
        <label>Class
          <select id="studentProfileSummaryClassFilter" aria-label="Filter category overview by class">
            ${classOptions}
          </select>
        </label>
    ...
    <div class="student-profile-summary-chart">
      <div class="student-profile-summary-scale" aria-hidden="true">
        <span>100%</span>
        <span>80%</span>
        <span>60%</span>
        <span>40%</span>
      ...
      <div class="student-profile-summary-bars" style="grid-template-columns: repeat(${summaryItems.length}, minmax(112px, 1fr)); min-width: ${gridMinWidth}px;">
        ${summaryItems.map((metric) => {
          const tooltip = `${metric.label}\nCount: ${metric.count}\nPercentage: ${metric.percentage.toFixed(2)}%\nClass: ${selectedClass}\nTotal Students: ${total}`;
          const colorStyle = `--cylinder-dark: ${metric.colors.dark}; --cylinder-mid: ${metric.colors.mid}; --cylinder-light: ${metric.colors.light}; --cylinder-glow: ${metric.colors.glow};`;
          return `
            <article class="student-profile-cylinder-card" style="${escapeAttr(colorStyle)}" tabindex="0" title="${escapeAttr(tooltip)}" aria-label="${escapeAttr(`${metric.label}: ${metric.count} students, ${metric.percentage.toFixed(2)} percent of ${selectedClass} enrolment.`)}">
              <div class="student-profile-cylinder">
                <div class="student-profile-cylinder-liquid" style="height: ${metric.percentage.toFixed(2)}%"></div>
                <span class="student-profile-cylinder-badge" style="bottom: min(calc(${metric.percentage.toFixed(2)}% + 8px), calc(100% - 44px))">${escapeHtml(formatCompactPercentage(metric.percentage))}</span>
              </div>
              <div class="student-profile-cylinder-label">
                <span>${escapeHtml(metric.label)}</span>
                <em>${metric.count} student${metric.count === 1 ? "" : "s"}</em>
              </div>
              <div class="student-profile-cylinder-tooltip">
                <strong>${escapeHtml(metric.label)}</strong>
                <span>Class: ${escapeHtml(selectedClass)}</span>
                <span>Count: ${metric.count}</span>
                <span>Percentage: ${metric.percentage.toFixed(2)}%</span>
...
function studentProfileCylinderPalette(index) {
  const palettes = [
    { dark: "#0c4f49", mid: "#01757a", light: "#8ed8d2", glow: "rgba(1, 117, 122, 0.3)" },
    { dark: "#0d47a1", mid: "#2f80ed", light: "#bbdcff", glow: "rgba(47, 128, 237, 0.3)" },
    { dark: "#4c1d95", mid: "#8b5cf6", light: "#ddd0ff", glow: "rgba(139, 92, 246, 0.3)" },
    { dark: "#9d174d", mid: "#ec4899", light: "#ffd1e8", glow: "rgba(236, 72, 153, 0.28)" },
    { dark: "#b45309", mid: "#f59e0b", light: "#ffe4a3", glow: "rgba(245, 158, 11, 0.3)" },
    { dark: "#047857", mid: "#34d399", light: "#c8f7e5", glow: "rgba(52, 211, 153, 0.3)" },
    { dark: "#7c2d12", mid: "#fb923c", light: "#ffd9bd", glow: "rgba(251, 146, 60, 0.28)" },
    { dark: "#0e7490", mid: "#22d3ee", light: "#c5f6ff", glow: "rgba(34, 211, 238, 0.28)" },
    { dark: "#4338ca", mid: "#6366f1", light: "#d5d8ff", glow: "rgba(99, 102, 241, 0.3)" },
    { dark: "#be123c", mid: "#fb7185", light: "#ffd6de", glow: "rgba(251, 113, 133, 0.28)" },
    { dark: "#166534", mid: "#84cc16", light: "#e2f7b7", glow: "rgba(132, 204, 22, 0.28)" },
    { dark: "#075985", mid: "#38bdf8", light: "#cdefff", glow: "rgba(56, 189, 248, 0.3)" },
    { dark: "#6d28d9", mid: "#a855f7", light: "#ead4ff", glow: "rgba(168, 85, 247, 0.28)" },
    { dark: "#334155", mid: "#94a3b8", light: "#e2e8f0", glow: "rgba(148, 163, 184, 0.28)" }
  ];
  return palettes[index % palettes.length];
}

function renderStudentProfileAgeReport(records) {
  if (!els.studentProfileAgeReport) return;
  const total = records.length;
  const ageCounts = new Map();
  records.forEach((record) => {
    const age = profileAge(record.dateOfBirth);
    const label = age === "" ? "DOB not set" : `${age} year${Number(age) === 1 ? "" : "s"}`;
    ageCounts.set(label, (ageCounts.get(label) || 0) + 1);
  });
  const rows = [...ageCounts.entries()].sort(([ageA], [ageB]) => {
    if (ageA === "DOB not set") return 1;
    if (ageB === "DOB not set") return -1;
    return Number.parseInt(ageA, 10) - Number.parseInt(ageB, 10);
  });
  const maxCount = Math.max(1, ...rows.map(([, count]) => count));
  els.studentProfileAgeReport.innerHTML = `
    <div class="student-profile-age-head">
      <div>
        <span class="eyebrow">Age-wise Report</span>
        <h4>Students by Age</h4>
      </div>
      <strong>${total} student${total === 1 ? "" : "s"}</strong>
    </div>
    <div class="student-profile-age-grid">
        ...
        return `
          <article>
            <div>
              ...
              <span>${count} student${count === 1 ? "" : "s"} | ${percentage.toFixed(2)}%</span>
            </div>
            <div class="student-profile-age-track" aria-hidden="true">
              <span style="width: ${width.toFixed(2)}%"></span>
            </div>
          </article>
        `;
      }).join("") : `<article><strong>No age data</strong><span>No matching students found.</span></article>`}
    </div>
  `;
}

function renderStudentProfileList(records) {
  const pageSize = isMobileView() ? 8 : 15;
  const totalPages = Math.max(1, Math.ceil(records.length / pageSize));
  studentProfilePage = clamp(Number(studentProfilePage) || 1, 1, totalPages);
  const start = (studentProfilePage - 1) * pageSize;
  const pageRecords = records.slice(start, start + pageSize);
  if (els.studentProfileCount) {
    els.studentProfileCount.textContent = `${records.length} student${records.length === 1 ? "" : "s"} shown`;
  }
  if (els.profilePageInfo) {
    els.profilePageInfo.textContent = `Page ${studentProfilePage} of ${totalPages}`;
  }
  if (els.profilePrevPageBtn) els.profilePrevPageBtn.disabled = studentProfilePage <= 1;
  if (els.profileNextPageBtn) els.profileNextPageBtn.disabled = studentProfilePage >= totalPages;

  els.studentProfileBody.innerHTML = pageRecords.length ? pageRecords.map(studentProfileRowHtml).join("") : `
    <tr><td colspan="12">No student profiles match the selected filters.</td></tr>
  `;
  els.studentProfileCards.innerHTML = pageRecords.length ? pageRecords.map(studentProfileCardHtml).join("") : `
    <article>No student profiles match the selected filters.</article>
  `;
}

function studentProfileRowHtml(record) {
  return `
    <tr>
      <td>${escapeHtml(record.rollNumber || "-")}</td>
      <td>${studentProfileAvatarHtml(record)}</td>
      <td>
        <button class="student-profile-name-button" type="button" data-profile-action="view" data-profile-id="${escapeAttr(record.studentId)}">
          ${escapeHtml(record.studentName || "-")}
        </button>
      </td>
      <td class="student-profile-class-cell">${escapeHtml(record.className || "-")}</td>
      ...
      <td>${studentProfileActionsHtml(record)}</td>
    </tr>
  `;
}

function studentProfileCardHtml(record) {
  return `
    <article>
      <div class="student-profile-card-head">
        ${studentProfileAvatarHtml(record)}
        <div>
          <strong>${escapeHtml(record.studentName || "-")}</strong>
          <span>${escapeHtml(record.className || "-")} ${record.section ? `- ${escapeHtml(record.section)}` : ""} | Roll ${escapeHtml(record.rollNumber || "-")}</span>
        </div>
        ${studentStatusBadge(record.studentStatus)}
      </div>
...
function primaryContact(record) {
  return record.primaryParentContact || record.fatherContact || record.motherContact || record.guardianContact || record.studentContact || "";
}

function studentStatusBadge(status) {
  const value = status || "Active";
  return `<span class="student-profile-status status-${escapeAttr(slugifyTeacherName(value))}">${escapeHtml(value)}</span>`;
}

function studentProfileActionsHtml(record) {
  const editable = canEditStudentProfileRecord(record);
  const admin = isAdmin();
  return `
    <div class="student-profile-actions">
      <button type="button" data-profile-action="view" data-profile-id="${escapeAttr(record.studentId)}">View</button>
      ${editable ? `<button type="button" data-profile-action="edit" data-profile-id="${escapeAttr(record.studentId)}">Edit</button>` : ""}
      <button type="button" data-profile-action="print" data-profile-id="${escapeAttr(record.studentId)}">Print</button>
      ${admin ? `<button type="button" data-profile-action="archive" data-profile-id="${escapeAttr(record.studentId)}">Archive</button>` : ""}
      ${admin ? `<button type="button" data-profile-action="transfer" data-profile-id="${escapeAttr(record.studentId)}">Transfer</button>` : ""}
      ${admin ? `<button type="button" data-profile-action="withdraw" data-profile-id="${escapeAttr(record.studentId)}">Withdrawn</button>` : ""}
      ${admin ? `<button class="danger" type="button" data-profile-action="delete" data-profile-id="${escapeAttr(record.studentId)}">Delete</button>` : ""}
    </div>
  `;
}

function handleStudentProfileAction(action, studentId) {
  const record = getStudentProfileRecords({ includeUnauthorized: true }).find((item) => item.studentId === studentId);
  if (!record) return;
  if (action === "view") return openStudentProfilePanel(record);
  if (action === "edit") return openStudentProfileForm(record);
  if (action === "print") return printStudentProfile(record);
  if (action === "archive") return updateStudentProfileStatus(record, "Inactive");
  if (action === "transfer") return updateStudentProfileStatus(record, "Transferred");
  if (action === "withdraw") return updateStudentProfileStatus(record, "Withdrawn");
  if (action === "delete") return deleteStudentProfile(record);
}

function openStudentProfilePanel(record) {
  els.studentProfilePanel.classList.remove("hidden");
  els.studentProfilePanel.innerHTML = `
    <div class="student-profile-panel-head">
      <div>
      ...
      <div class="student-profile-actions">
        ...
        <button type="button" data-profile-action="print" data-profile-id="${escapeAttr(record.studentId)}">Print Profile</button>
      </div>
    </div>
...
function studentProfileDetail(label, value) {
  return `<div><span>${escapeHtml(label)}</span><strong>${escapeHtml(value || "-")}</strong></div>`;
}

function displayIdentifier(value) {
  if (!value) return "";
  return isAdmin() || isPrincipalUser() || isHeadmasterUser() ? value : maskIdentifier(value);
}
...
function openNewStudentProfileForm() {
  openStudentProfileForm(null);
}

function openStudentProfileForm(record = null) {
  if (record && !canEditStudentProfileRecord(record)) {
    showToast("You do not have permission to edit this student profile.");
    return;
  }
  if (!record && !(isAdmin() || isPrincipalUser() || isHeadmasterUser())) {
    showToast("Only authorized users can create student profiles.");
    return;
  }
  editingStudentProfileId = record?.studentId || "";
  studentProfilePhotoDraft = null;
  revokeStudentPhotoPreviewUrl();
  resetStudentPhotoCropState();
  els.studentProfileForm.classList.remove("hidden");
  els.studentProfileFormTitle.textContent = record ? `Edit ${record.studentName}` : "Add New Student";
  fillStudentProfileForm(record || {});
  els.studentProfileForm.scrollIntoView({ behavior: "smooth", block: "start" });
}

function closeStudentProfileForm() {
  editingStudentProfileId = "";
  studentProfilePhotoDraft = null;
  revokeStudentPhotoPreviewUrl();
...
function fillStudentProfileForm(record = {}) {
  const set = (input, value) => {
    if (input) input.value = value ?? "";
  };
  set(els.profileRollInput, record.rollNumber || "");
  set(els.profileNameInput, record.studentName || "");
  setSelectValueIfAvailable(els.profileClassInput, record.className || selectedClass());
  set(els.profileSectionInput, record.section || "");
  set(els.profileSchoolIdInput, record.schoolIdNo || "");
  setSelectValueIfAvailable(els.profileGenderInput, record.gender || "Male");
  set(els.profileDobInput, formatDateForInput(record.dateOfBirth));
  set(els.profileAgeInput, profileAge(record.dateOfBirth));
  setSelectValueIfAvailable(els.profileBloodGroupInput, record.bloodGroup || "Unknown");
  setSelectValueIfAvailable(els.profileHouseInput, record.houseColour || "");
  set(els.profileAddressInput, record.address || "");
  set(els.profileLandmarkInput, record.landmark || "");
  set(els.profileStudentContactInput, record.studentContact || "");
  set(els.profilePrimaryContactInput, record.primaryParentContact || "");
  set(els.profileAlternateContactInput, record.alternateContact || "");
  set(els.profilePenInput, record.pen || "");
  set(els.profileAadhaarInput, record.aadhaarNo || "");
  set(els.profileAparInput, record.aparId || "");
  set(els.profileNationalityInput, record.nationality || "Indian");
  set(els.profileFatherInput, record.fatherName || "");
  set(els.profileFatherContactInput, record.fatherContact || "");
  set(els.profileMotherInput, record.motherName || "");
  set(els.profileMotherContactInput, record.motherContact || "");
  set(els.profileGuardianInput, record.guardianName || "");
  set(els.profileGuardianRelationshipInput, record.guardianRelationship || "");
  set(els.profileGuardianContactInput, record.guardianContact || "");
  set(els.profileParentAadhaarInput, record.parentGuardianAadhaar || "");
  setSelectValueIfAvailable(els.profileReligionInput, record.religion || "");
  setSelectValueIfAvailable(els.profileDenominationInput, record.denomination || "");
  setSelectValueIfAvailable(els.profileBplAayInput, record.bplAay || "None");
  setSelectValueIfAvailable(els.profileResidentialInput, record.residentialStatus || "Day Scholar");
  setSelectValueIfAvailable(els.profileAdmissionInput, record.admissionType || "Continuing Student");
  set(els.profileAdmissionNoInput, record.admissionNo || "");
  set(els.profileAdmissionDateInput, formatDateForInput(record.dateOfAdmission));
  setSelectValueIfAvailable(els.profileStatusInput, record.studentStatus || "Active");
  setSelectValueIfAvailable(els.profileSkillProgrammeInput, record.skillDevelopmentProgramme || "");
  set(els.profileSkillGroupInput, record.skillDevelopmentGroup || "");
...
function updateStudentProfileAge() {
  if (els.profileAgeInput) els.profileAgeInput.value = profileAge(els.profileDobInput?.value || "");
}

function profileAge(dateValue) {
...
function handleStudentProfilePhotoPreview() {
  const file = els.profilePhotoInput?.files?.[0] || null;
  studentProfilePhotoDraft = null;
  if (!file || !els.profilePhotoPreview) return;
  if (!["image/jpeg", "image/png", "image/webp"].includes(file.type)) {
    showToast("Please select a JPEG, PNG, or WebP photo.");
    els.profilePhotoInput.value = "";
    return;
  }
  openStudentPhotoCropModal(file);
}

function openStudentPhotoCropModal(file) {
  const image = new Image();
  const url = URL.createObjectURL(file);
  studentProfilePhotoPreviousPreviewHtml = els.profilePhotoPreview?.innerHTML || "";
  image.onload = () => {
    if (studentPhotoCropState.objectUrl) URL.revokeObjectURL(studentPhotoCropState.objectUrl);
    studentPhotoCropState.image = image;
    studentPhotoCropState.objectUrl = url;
    resetStudentPhotoCrop();
    els.studentPhotoCropModal?.classList.remove("hidden");
    els.profilePhotoPreview.innerHTML = `<span>Adjust</span>`;
  };
  image.onerror = () => {
    URL.revokeObjectURL(url);
    showToast("Could not load this photo. Please choose another image.");
    if (els.profilePhotoInput) els.profilePhotoInput.value = "";
  };
  image.src = url;
}

function resetStudentPhotoCropState() {
  if (studentPhotoCropState.objectUrl) URL.revokeObjectURL(studentPhotoCropState.objectUrl);
  studentPhotoCropState.image = null;
  studentPhotoCropState.objectUrl = "";
  studentPhotoCropState.zoom = 1;
  studentPhotoCropState.minScale = 1;
  studentPhotoCropState.offsetX = 0;
  studentPhotoCropState.offsetY = 0;
  studentPhotoCropState.dragging = false;
}

function resetStudentPhotoCrop() {
  const canvas = els.studentPhotoCropCanvas;
  const image = studentPhotoCropState.image;
  if (!canvas || !image) return;
  const size = canvas.width || 320;
  studentPhotoCropState.minScale = Math.max(size / image.width, size / image.height);
  studentPhotoCropState.zoom = 1;
  studentPhotoCropState.offsetX = 0;
  studentPhotoCropState.offsetY = 0;
  if (els.studentPhotoZoomInput) els.studentPhotoZoomInput.value = "1";
  renderStudentPhotoCropCanvas();
}

function updateStudentPhotoCropZoom() {
  const nextZoom = Number(els.studentPhotoZoomInput?.value || 1);
  studentPhotoCropState.zoom = Math.min(3, Math.max(1, Number.isFinite(nextZoom) ? nextZoom : 1));
  renderStudentPhotoCropCanvas();
}

function studentPhotoCropGeometry() {
  const canvas = els.studentPhotoCropCanvas;
  const image = studentPhotoCropState.image;
  const size = canvas?.width || 320;
  const scale = studentPhotoCropState.minScale * studentPhotoCropState.zoom;
  const width = image ? image.width * scale : size;
  const height = image ? image.height * scale : size;
  return {
    size,
    scale,
    width,
    height,
    x: (size - width) / 2 + studentPhotoCropState.offsetX,
    y: (size - height) / 2 + studentPhotoCropState.offsetY
  };
}

function clampStudentPhotoCropOffset() {
  const { size, width, height } = studentPhotoCropGeometry();
  const limitX = Math.max(0, (width - size) / 2);
  const limitY = Math.max(0, (height - size) / 2);
  studentPhotoCropState.offsetX = Math.min(limitX, Math.max(-limitX, studentPhotoCropState.offsetX));
  studentPhotoCropState.offsetY = Math.min(limitY, Math.max(-limitY, studentPhotoCropState.offsetY));
}

function renderStudentPhotoCropCanvas() {
  const canvas = els.studentPhotoCropCanvas;
  const image = studentPhotoCropState.image;
  if (!canvas || !image) return;
  const context = canvas.getContext("2d");
  if (!context) return;
  clampStudentPhotoCropOffset();
  const { size, width, height, x, y } = studentPhotoCropGeometry();
...
function startStudentPhotoCropDrag(event) {
  if (!studentPhotoCropState.image) return;
  studentPhotoCropState.dragging = true;
  studentPhotoCropState.dragStartX = event.clientX;
  studentPhotoCropState.dragStartY = event.clientY;
  studentPhotoCropState.startOffsetX = studentPhotoCropState.offsetX;
  studentPhotoCropState.startOffsetY = studentPhotoCropState.offsetY;
  els.studentPhotoCropCanvas?.setPointerCapture?.(event.pointerId);
}

function dragStudentPhotoCrop(event) {
  if (!studentPhotoCropState.dragging) return;
  studentPhotoCropState.offsetX = studentPhotoCropState.startOffsetX + event.clientX - studentPhotoCropState.dragStartX;
  studentPhotoCropState.offsetY = studentPhotoCropState.startOffsetY + event.clientY - studentPhotoCropState.dragStartY;
  renderStudentPhotoCropCanvas();
}

function endStudentPhotoCropDrag(event) {
  if (!studentPhotoCropState.dragging) return;
  studentPhotoCropState.dragging = false;
  if (els.studentPhotoCropCanvas?.hasPointerCapture?.(event.pointerId)) {
    els.studentPhotoCropCanvas.releasePointerCapture(event.pointerId);
  }
}

function closeStudentPhotoCropModal() {
  els.studentPhotoCropModal?.classList.add("hidden");
  if (!studentProfilePhotoDraft) {
    if (els.profilePhotoInput) els.profilePhotoInput.value = "";
    if (els.profilePhotoPreview) els.profilePhotoPreview.innerHTML = studentProfilePhotoPreviousPreviewHtml;
  }
  resetStudentPhotoCropState();
}
...
async function applyStudentPhotoCrop(options = {}) {
  ...
  const image = studentPhotoCropState.image;
  if (!canvas || !image) return;
  const { size, scale, x, y } = studentPhotoCropGeometry();
  const sourceX = Math.max(0, -x / scale);
  const sourceY = Math.max(0, -y / scale);
  const sourceSize = Math.min(image.width - sourceX, image.height - sourceY, size / scale);
  ...
  const blob = await compressStudentPhotoCanvas(output);
  if (!blob) {
    showToast("Could not prepare this photo. Please try another image.");
    return;
  }
  studentProfilePhotoDraft = typeof File === "function"
    ? new File([blob], "profile.webp", { type: "image/webp" })
    : blob;
  revokeStudentPhotoPreviewUrl();
  studentProfilePhotoPreviewUrl = URL.createObjectURL(blob);
  if (els.profilePhotoPreview) {
    els.profilePhotoPreview.innerHTML = `<img src="${escapeAttr(studentProfilePhotoPreviewUrl)}" alt="">`;
  }
...
function compressStudentPhotoCanvas(canvas) {
  ...
  return new Promise((resolve) => {
    const tryQuality = (index) => {
      const quality = qualities[index] ?? qualities[qualities.length - 1];
      canvas.toBlob((blob) => {
        if (!blob) {
          resolve(null);
          return;
...
function revokeStudentPhotoPreviewUrl() {
  if (studentProfilePhotoPreviewUrl) URL.revokeObjectURL(studentProfilePhotoPreviewUrl);
  studentProfilePhotoPreviewUrl = "";
}

function formatFileSize(bytes) {
  const value = Number(bytes);
  if (!Number.isFinite(value) || value <= 0) return "a small size";
  if (value < 1024) return `${Math.round(value)} B`;
  return `${Math.max(1, Math.round(value / 1024))} KB`;
}

function readStudentProfileForm() {
  const get = (input) => String(input?.value || "").trim();
  const now = new Date().toISOString();
  const existing = editingStudentProfileId ? state.studentProfiles?.[editingStudentProfileId] || {} : {};
  const existingEnrolment = editingStudentProfileId
    ? state.studentEnrolments?.[currentSessionKey(state.academicSession)]?.[editingStudentProfileId] || {}
    : {};
  const studentId = editingStudentProfileId || `student-${Date.now()}-${Math.random().toString(36).slice(2, 7)}`;
  const profile = normalizeStudentProfile({
    ...existing,
    studentId,
    studentName: get(els.profileNameInput),
    schoolIdNo: get(els.profileSchoolIdInput),
    gender: get(els.profileGenderInput),
    dateOfBirth: get(els.profileDobInput),
    bloodGroup: get(els.profileBloodGroupInput),
    address: get(els.profileAddressInput),
    landmark: get(els.profileLandmarkInput),
    studentContact: get(els.profileStudentContactInput),
    primaryParentContact: els.profilePrimaryContactInput ? get(els.profilePrimaryContactInput) : existing.primaryParentContact || "",
    alternateContact: els.profileAlternateContactInput ? get(els.profileAlternateContactInput) : existing.alternateContact || "",
    pen: get(els.profilePenInput),
    aadhaarNo: get(els.profileAadhaarInput),
    aparId: get(els.profileAparInput),
    fatherName: get(els.profileFatherInput),
    fatherContact: get(els.profileFatherContactInput),
    motherName: get(els.profileMotherInput),
    motherContact: get(els.profileMotherContactInput),
    guardianName: get(els.profileGuardianInput),
    guardianRelationship: get(els.profileGuardianRelationshipInput),
    guardianContact: get(els.profileGuardianContactInput),
    parentGuardianAadhaar: get(els.profileParentAadhaarInput),
    nationality: get(els.profileNationalityInput) || "Indian",
    religion: get(els.profileReligionInput),
    denomination: get(els.profileDenominationInput),
    bplAay: get(els.profileBplAayInput),
    admissionNo: get(els.profileAdmissionNoInput),
    dateOfAdmission: get(els.profileAdmissionDateInput),
  ...
  const enrolment = normalizeStudentEnrolment({
    ...existingEnrolment,
    studentId,
    academicSessionId: currentSessionKey(state.academicSession),
    className: get(els.profileClassInput),
    section: get(els.profileSectionInput),
    rollNumber: get(els.profileRollInput),
    houseColour: get(els.profileHouseInput),
    residentialStatus: get(els.profileResidentialInput),
    admissionType: get(els.profileAdmissionInput),
    skillDevelopmentProgramme: get(els.profileSkillProgrammeInput),
    skillDevelopmentGroup: els.profileSkillGroupInput ? get(els.profileSkillGroupInput) : existingEnrolment.skillDevelopmentGroup || "",
    instructor: els.profileInstructorInput ? get(els.profileInstructorInput) : existingEnrolment.instructor || "",
    studentStatus: get(els.profileStatusInput) || "Active"
  });
  return { profile, enrolment };
}
...
async function saveStudentProfileFromForm(event, options = {}) {
  ...
  try {
    ...
    state.studentEnrolments = state.studentEnrolments || {};
    const session = currentSessionKey(state.academicSession);
    state.studentEnrolments[session] = state.studentEnrolments[session] || {};
    recordStudentProfileAudit(oldRecord, profile, enrolment);
...
function validateStudentProfilePayload(profile, enrolment) {
  ...
  const birthDate = parseIsoDate(profile.dateOfBirth);
  const admissionDate = parseIsoDate(profile.dateOfAdmission);
  if (birthDate && birthDate > new Date()) errors.push("Date of Birth cannot be in the future.");
  if (birthDate && admissionDate && admissionDate < birthDate) errors.push("Date of Admission cannot be earlier than Date of Birth.");
  ["aadhaarNo", "parentGuardianAadhaar"].forEach((field) => {
    const value = String(profile[field] || "").trim();
    if (value && !/^\d{12}$/.test(value)) errors.push("Aadhaar number must contain exactly 12 digits.");
  });
  [
    profile.studentContact,
    profile.primaryParentContact,
    ...
    profile.motherContact,
    profile.guardianContact
  ].filter(Boolean).forEach((phone) => {
    if (!/^\+?[0-9\s-]{7,18}$/.test(phone)) errors.push("Please enter a valid contact number.");
  });
  errors.push(...studentProfileDuplicateErrors(profile, enrolment));
  return [...new Set(errors)];
}

function studentProfileDuplicateErrors(profile, enrolment) {
  const records = getStudentProfileRecords({ includeUnauthorized: true }).filter((record) => record.studentId !== profile.studentId);
  const errors = [];
  const duplicateField = (field, label) => {
    const value = String(profile[field] || "").trim().toLowerCase();
    if (value && records.some((record) => String(record[field] || "").trim().toLowerCase() === value)) {
      errors.push(`${label} already exists in another student profile.`);
    }
  };
  duplicateField("schoolIdNo", "School ID No.");
  ...
  if (roll && records.some((record) =>
    record.className === enrolment.className
    && String(record.section || "").trim().toLowerCase() === section
    && String(record.rollNumber || "").trim() === roll
  )) {
    errors.push("Roll No. already exists in this Academic Session, Class, and Section.");
  }
  return errors;
}

function syncStudentProfileToLegacyClassList(profile, enrolment, oldRecord = null) {
  state.classes[enrolment.className] = state.classes[enrolment.className] || [];
  if (oldRecord?.className && oldRecord.className !== enrolment.className) {
    state.classes[oldRecord.className] = (state.classes[oldRecord.className] || [])
      .filter((student) => String(student.studentId || studentProfileIdFromLegacy(oldRecord.className, student)) !== profile.studentId);
  }
  const students = state.classes[enrolment.className];
  const oldRoll = oldRecord?.className === enrolment.className ? String(oldRecord.rollNumber || "") : "";
  let index = students.findIndex((student) => String(student.studentId || "") === profile.studentId);
  if (index === -1 && oldRoll) {
    index = students.findIndex((student) => String(student.roll || "") === oldRoll);
  }
  if (index === -1) {
    index = students.findIndex((student) => String(student.roll || "") === String(enrolment.rollNumber || ""));
  }
  const legacy = normalizeStudent({
    studentId: profile.studentId,
    roll: Number(enrolment.rollNumber) || enrolment.rollNumber,
    idNo: profile.schoolIdNo,
  ...
  if (index >= 0) {
    const previousRoll = students[index].roll;
    students[index] = legacy;
    if (String(previousRoll) !== String(legacy.roll)) moveStudentRecordsForClass(enrolment.className, previousRoll, legacy.roll);
  } else {
    students.push(legacy);
  }
}

function moveStudentRecordsForClass(className, oldRoll, newRoll) {
  [state.marks, state.attendance, state.measurements].forEach((collection) => {
    Object.keys(collection || {}).forEach((key) => {
      if (!key.startsWith(`${className}::`) || collection[key]?.[String(oldRoll)] === undefined) return;
...
function recordStudentProfileAudit(oldRecord, profile, enrolment) {
  const tracked = [
    ["aadhaarNo", oldRecord?.aadhaarNo, profile.aadhaarNo],
    ["pen", oldRecord?.pen, profile.pen],
    ["aparId", oldRecord?.aparId, profile.aparId],
    ["dateOfBirth", oldRecord?.dateOfBirth, profile.dateOfBirth],
    ["admissionNo", oldRecord?.admissionNo, profile.admissionNo],
    ["className", oldRecord?.className, enrolment.className],
    ["studentStatus", oldRecord?.studentStatus, enrolment.studentStatus]
  ];
  const changes = tracked
    .filter(([, before, after]) => String(before || "") !== String(after || ""))
    .map(([field, before, after]) => ({ field, before: before || "", after: after || "" }));
  if (!changes.length) return;
  state.studentProfileAudit = state.studentProfileAudit || [];
  state.studentProfileAudit.push({
...
async function updateStudentProfileStatus(record, status) {
  if (!isAdmin()) {
    showToast("Only admin can change student status from this action.");
    return;
  }
  const profile = normalizeStudentProfile(state.studentProfiles?.[record.studentId] || record);
  const enrolment = normalizeStudentEnrolment({ ...record, studentStatus: status });
  state.studentProfiles[profile.studentId] = profile;
  ...
  if (window.MarkHubFirebase?.saveStudentProfileRecord) {
    try {
      ...
      console.warn("[Firestore] Student profile status split write skipped", error);
    }
  }
  renderStudentProfiles();
  showToast(`Student marked ${status}.`);
}

async function deleteStudentProfile(record) {
  if (!isAdmin()) return;
...
function printStudentProfile(record) {
  openStudentProfilePanel(record);
  startPrintMode("print-student-profiles");
}

function printStudentProfilesList() {
  startPrintMode("print-student-profiles");
}

function exportStudentProfilesCsv() {
  if (!isAdmin() && !isPrincipalUser() && !isHeadmasterUser()) {
    showToast("Only authorized users can export student profiles.");
    return;
  }
  const rows = [[
    "Student ID",
  ...
  visibleStudentProfileRecords().forEach((record) => {
    rows.push([
      record.studentId,
      record.rollNumber,
      record.studentName,
      ...
      record.guardianName,
      record.guardianRelationship,
      record.guardianContact,
      record.parentGuardianAadhaar,
      record.religion,
      record.denomination,
      record.bplAay,
      record.residentialStatus,
      record.admissionType,
      record.admissionNo,
      formatDisplayDate(record.dateOfAdmission),
      record.studentStatus,
      record.skillDevelopmentProgramme,
      record.skillDevelopmentGroup,
      record.instructor,
      record.photoURL,
      currentSessionKey(state.academicSession),
      record.createdAt,
      record.createdBy,
      record.updatedAt,
      record.updatedBy
  ...
  downloadCsv(rows, `Student_Profiles_${currentSessionKey(state.academicSession)}.csv`);
}

function downloadStudentProfileCsvSample() {
  if (!isAdmin()) {
    showToast("Only admin can download student profile CSV samples.");
    return;
  }
  const rows = [
    [
  ...
  downloadCsv(rows, `Student_Profile_CSV_Sample_${currentSessionKey(state.academicSession)}.csv`);
}

async function importStudentProfilesCsv(event) {
  if (!isAdmin()) {
    event.target.value = "";
    showToast("Only admin can import student profiles CSV.");
    return;
  }
  ...
  try {
    ...
    const result = await mergeStudentProfilesFromCsv(rows);
    initializeStudentProfileControls(captureUiState());
    renderStudentProfiles();
    const splitNote = result.splitSkipped
      ? ` ${result.splitSkipped} split profile write${result.splitSkipped === 1 ? "" : "s"} skipped.`
      : "";
    showToast(`${result.added} added, ${result.updated} updated, ${result.skipped} skipped.${splitNote}`);
  } catch (error) {
    console.error("[Student Profiles] CSV import failed", error);
    showToast(error.message || "Could not import student profiles CSV.");
  } finally {
    event.target.value = "";
  }
}

async function mergeStudentProfilesFromCsv(rows) {
  if (rows.length < 2) {
    throw new Error("CSV must include a header and at least one student profile.");
  }

  const headers = rows[0].map(normalizeCsvHeader);
  const index = (...aliases) => headers.findIndex((header) => aliases.includes(header));
  const indexes = {
    studentId: index("studentid", "profileid"),
    roll: index("roll", "rollno", "rollnumber"),
    name: index("name", "studentname"),
    className: index("class", "classname"),
    section: index("section"),
    schoolIdNo: index("schoolidno", "schoolid", "idno", "idnumber"),
    gender: index("gender"),
    dateOfBirth: index("dateofbirth", "dob"),
    bloodGroup: index("bloodgroup"),
    houseColour: index("housecolour", "housecolor", "house"),
    address: index("address"),
    landmark: index("landmark"),
    studentContact: index("studentcontact", "studentcontactno", "studentcontactnumber"),
    primaryParentContact: index("primaryparentcontact", "primaryparentcontactno", "primarycontact", "primarycontactno", "contact", "contactnumber"),
    alternateContact: index("alternatecontact", "alternatecontactno", "alternatecontactnumber"),
    pen: index("pen"),
    aadhaarNo: index("aadhaarno", "aadharnumber", "aadhaarnumber"),
    aparId: index("aparid", "apar"),
    fatherName: index("fathersname", "fathername"),
    fatherContact: index("fathercontact", "fathercontactno"),
    motherName: index("mothersname", "mothername"),
    motherContact: index("mothercontact", "mothercontactno"),
    guardianName: index("guardiansname", "guardianname"),
    guardianRelationship: index("guardianrelationship", "relationship"),
    guardianContact: index("guardiancontact", "guardiancontactno"),
    parentGuardianAadhaar: index("parentguardianaadhaar", "parentguardianaadhaarno"),
    nationality: index("nationality"),
    religion: index("religion"),
    denomination: index("denomination"),
    bplAay: index("bplaay", "bpl", "aay"),
    residentialStatus: index("residentialstatus", "residential"),
    admissionType: index("admissiontype"),
    admissionNo: index("admissionno", "admissionnumber"),
    dateOfAdmission: index("dateofadmission", "admissiondate"),
    studentStatus: index("studentstatus", "status"),
    skillDevelopmentProgramme: index("skilldevelopmentprogramme", "skilldevelopmentprogram", "skilldevelopment", "programme", "program"),
    skillDevelopmentGroup: index("skilldevelopmentgroup", "skillgroup", "group"),
    instructor: index("instructor"),
    photoURL: index("photourl", "photo")
  };

  if (indexes.name === -1) {
    throw new Error('CSV headers must include "Name" or "Student Name".');
  }
  ...
  rows.slice(1).forEach((row) => {
    ...
    const rawName = csvValue(row, indexes.name);
    const className = normalizeImportedClassName(csvValue(row, indexes.className))
      || concreteStudentProfileFilterClass()
      || selectedClass();
    const existingRecord = findStudentProfileImportMatch(row, indexes, className, session);
    const studentId = csvValue(row, indexes.studentId)
      || existingRecord?.studentId
      || `student-${Date.now()}-${Math.random().toString(36).slice(2, 7)}`;
    const existingProfile = state.studentProfiles?.[studentId] || (existingRecord ? state.studentProfiles?.[existingRecord.studentId] : {}) || {};
    const existingEnrolment = state.studentEnrolments?.[session]?.[studentId] || existingRecord || {};
    const now = new Date().toISOString();

    const profile = normalizeStudentProfile({
      ...existingProfile,
      studentId,
      studentName: rawName || existingProfile.studentName || existingRecord?.studentName || "",
      schoolIdNo: csvValue(row, indexes.schoolIdNo) || existingProfile.schoolIdNo || existingRecord?.schoolIdNo || "",
      gender: normalizeImportedOption(csvValue(row, indexes.gender), profileGenderOptions, existingProfile.gender || existingRecord?.gender || ""),
      dateOfBirth: csvValue(row, indexes.dateOfBirth) || existingProfile.dateOfBirth || existingRecord?.dateOfBirth || "",
      bloodGroup: normalizeImportedOption(csvValue(row, indexes.bloodGroup), profileBloodGroupOptions, existingProfile.bloodGroup || "Unknown"),
      address: csvValue(row, indexes.address) || existingProfile.address || "",
      landmark: csvValue(row, indexes.landmark) || existingProfile.landmark || "",
      studentContact: csvValue(row, indexes.studentContact) || existingProfile.studentContact || "",
      primaryParentContact: csvValue(row, indexes.primaryParentContact) || existingProfile.primaryParentContact || existingRecord?.primaryParentContact || "",
      alternateContact: csvValue(row, indexes.alternateContact) || existingProfile.alternateContact || "",
      pen: csvValue(row, indexes.pen) || existingProfile.pen || "",
      aadhaarNo: csvValue(row, indexes.aadhaarNo) || existingProfile.aadhaarNo || "",
      aparId: csvValue(row, indexes.aparId) || existingProfile.aparId || "",
      fatherName: csvValue(row, indexes.fatherName) || existingProfile.fatherName || "",
      fatherContact: csvValue(row, indexes.fatherContact) || existingProfile.fatherContact || "",
      motherName: csvValue(row, indexes.motherName) || existingProfile.motherName || "",
      motherContact: csvValue(row, indexes.motherContact) || existingProfile.motherContact || "",
      guardianName: csvValue(row, indexes.guardianName) || existingProfile.guardianName || "",
      guardianRelationship: csvValue(row, indexes.guardianRelationship) || existingProfile.guardianRelationship || "",
      guardianContact: csvValue(row, indexes.guardianContact) || existingProfile.guardianContact || "",
      parentGuardianAadhaar: csvValue(row, indexes.parentGuardianAadhaar) || existingProfile.parentGuardianAadhaar || "",
      nationality: csvValue(row, indexes.nationality) || existingProfile.nationality || "Indian",
      religion: normalizeImportedOption(csvValue(row, indexes.religion), profileReligionOptions, existingProfile.religion || ""),
      denomination: normalizeImportedOption(csvValue(row, indexes.denomination), profileDenominationOptions, existingProfile.denomination || ""),
      bplAay: normalizeImportedOption(csvValue(row, indexes.bplAay), profileBplAayOptions, existingProfile.bplAay || "None"),
      admissionNo: csvValue(row, indexes.admissionNo) || existingProfile.admissionNo || "",
      dateOfAdmission: csvValue(row, indexes.dateOfAdmission) || existingProfile.dateOfAdmission || "",
      photoURL: csvValue(row, indexes.photoURL) || existingProfile.photoURL || "",
      createdAt: existingProfile.createdAt || now,
      createdBy: existingProfile.createdBy || currentUserLabel(),
      updatedAt: now,
      updatedBy: currentUserLabel()
    });
    ...
    const enrolment = normalizeStudentEnrolment({
      ...
      academicSessionId: session,
      className,
      section: csvValue(row, indexes.section) || existingEnrolment.section || existingRecord?.section || "",
      rollNumber: csvValue(row, indexes.roll) || existingEnrolment.rollNumber || existingRecord?.rollNumber || "",
      houseColour: normalizeHouseColour(csvValue(row, indexes.houseColour) || existingEnrolment.houseColour || existingRecord?.houseColour || ""),
      residentialStatus: normalizeImportedOption(csvValue(row, indexes.residentialStatus), profileResidentialOptions, existingEnrolment.residentialStatus || "Day Scholar"),
      admissionType: normalizeImportedOption(csvValue(row, indexes.admissionType), profileAdmissionOptions, existingEnrolment.admissionType || "Continuing Student"),
      skillDevelopmentProgramme: csvValue(row, indexes.skillDevelopmentProgramme) || existingEnrolment.skillDevelopmentProgramme || "",
      skillDevelopmentGroup: csvValue(row, indexes.skillDevelopmentGroup) || existingEnrolment.skillDevelopmentGroup || "",
      instructor: csvValue(row, indexes.instructor) || existingEnrolment.instructor || "",
      studentStatus: normalizeImportedOption(csvValue(row, indexes.studentStatus), profileStatusOptions, existingEnrolment.studentStatus || "Active"),
      createdAt: existingEnrolment.createdAt || now,
      updatedAt: now
    });
    ...
    const oldRecord = existingRecord || null;
    recordStudentProfileAudit(oldRecord, profile, enrolment);
    state.studentProfiles[studentId] = profile;
    state.studentEnrolments[session][studentId] = enrolment;
    syncStudentProfileToLegacyClassList(profile, enrolment, oldRecord);
    touchedClasses.add(enrolment.className);
    if (oldRecord?.className && oldRecord.className !== enrolment.className) touchedClasses.add(oldRecord.className);
    splitWrites.push({ profile, enrolment, session });
    if (existingRecord) updated += 1;
    else added += 1;
  });

  saveState();
  for (const className of touchedClasses) {
    await saveClassStudents(className);
  }
  let splitSkipped = 0;
  if (window.MarkHubFirebase?.saveStudentProfileRecord) {
    for (const payload of splitWrites) {
      try {
        await window.MarkHubFirebase.saveStudentProfileRecord(payload);
      } catch (error) {
        splitSkipped += 1;
        console.warn("[Firestore] Student profile split import write skipped", error);
      }
    }
  }

  return { added, updated, skipped, splitSkipped };
}

function concreteStudentProfileFilterClass() {
  const value = String(els.profileClassFilter?.value || "");
  return classNames.includes(value) ? value : "";
}

function findStudentProfileImportMatch(row, indexes, className, session) {
  const records = getStudentProfileRecords({ includeUnauthorized: true });
  const values = {
    studentId: csvValue(row, indexes.studentId),
    schoolIdNo: csvValue(row, indexes.schoolIdNo),
    admissionNo: csvValue(row, indexes.admissionNo),
    pen: csvValue(row, indexes.pen),
    aadhaarNo: csvValue(row, indexes.aadhaarNo),
    aparId: csvValue(row, indexes.aparId),
    rollNumber: csvValue(row, indexes.roll),
    section: csvValue(row, indexes.section)
  };
  const same = (field) => {
    const value = String(values[field] || "").trim().toLowerCase();
    return value ? records.find((record) => String(record[field] || "").trim().toLowerCase() === value) : null;
  };
  return same("studentId")
    || same("schoolIdNo")
    || same("admissionNo")
    || same("pen")
    || same("aadhaarNo")
    || same("aparId")
    || (values.rollNumber ? records.find((record) =>
      record.className === className
      && String(record.rollNumber || "").trim() === String(values.rollNumber || "").trim()
      && String(record.section || "").trim().toLowerCase() === String(values.section || "").trim().toLowerCase()
    ) : null)
    || (values.rollNumber ? Object.values(state.studentEnrolments?.[session] || {}).find((enrolment) =>
      enrolment.className === className
      && String(enrolment.rollNumber || "").trim() === String(values.rollNumber || "").trim()
      && String(enrolment.section || "").trim().toLowerCase() === String(values.section || "").trim().toLowerCase()
    ) : null);
}
...
function normalizeImportedClassName(value) {
  ...
  return classNames.find((className) => className.toLowerCase() === normalized) || "";
}

function normalizeImportedOption(value, options, fallback = "") {
  const text = String(value || "").trim();
